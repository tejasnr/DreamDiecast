...
export default function HomeClient() {
  ...
  return (
    <main className="min-h-screen">
      ...
      {/* About DreamDiecast — citable content block for AI search engines */}
      <section className="py-16 border-t border-white/5">
        <article className="max-w-3xl mx-auto px-6 text-center">
          <h2 className="text-2xl font-display font-bold uppercase tracking-tighter mb-6">
            India&apos;s Premier <span className="text-accent">Diecast</span> Destination
          </h2>
          <p className="text-white/40 text-sm leading-relaxed mb-4">
            DreamDiecast is India&apos;s premier online store for premium diecast car collectibles. Based in Bangalore, we stock 1:64, 1:43, and 1:24 scale models from brands including Hot Wheels, Mini GT, Tarmac Works, Bburago, Pop Race, and Matchbox. Whether you&apos;re hunting JDM legends like the Nissan Skyline GT-R and Toyota Supra, exotic hypercars from Lamborghini and Ferrari, or motorsport replicas with authentic racing liveries — your next grail piece is here.
          </p>
          <p className="text-white/40 text-sm leading-relaxed">
            Every model is 100% authentic, sourced from authorized distributors. We ship across India with secure collector-grade packaging — individually bubble-wrapped and placed in rigid shipping boxes to ensure your models arrive in perfect condition.
          </p>
        </article>
      </section>
